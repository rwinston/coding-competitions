import unittest
from Advent2019 import Day1, Day2, Day3, Day4
...
class Day3TestCase(unittest.TestCase):
    def test_solve_simple(self):
        puzzle = Day3(['R8,U5,L5,D3','U7,R6,D4,L4'], 20)
        distances = puzzle.solve_part1()
    ...
    def test_solve_simple2(self):
        puzzle = Day3(['R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51', 'U98,R91,D20,R16,D67,R40,U7,R15,U6,R7'], 500)
        distances = puzzle.solve_part1()
        print(min(distances))
        print(len(distances))
    ...
    def test_solve_simple3(self):
        puzzle = Day3(['R75,D30,R83,U83,L12,D49,R71,U7,L72', 'U62,R66,U55,R34,D71,R55,D58,R83'], 500)
        distances = puzzle.solve_part1()
        print(min(distances))
        print(len(distances))
        self.assertEqual(135, min(distances))
